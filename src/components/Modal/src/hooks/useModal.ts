import { shallowRef, reactive, watchEffect, nextTick, onUnmounted, getCurrentInstance } from 'vue';
...
export const useModal = () => {
  ...
  const getModal = (): any => {
    ...
    if (!modal) console.error('useModal instance is undefined!');
    return modal;
  };
...
export const useModalInner = (callbackFn?: (data?: any) => void) => {
