...
export function columnsUtil(schema: any, tableFields: string[]): DataTableColumn[] {
...
export function formSchemaUtil(schema: any, formFields: string[]) {
  const { properties, setting } = schema
...
export function editFormSchemaUtil(schema: any, editFormFields: string[]) {
  const { properties, setting } = schema
...
export function descriptionSchemaUtil(schema: any, descriptionFields: string[]) {
